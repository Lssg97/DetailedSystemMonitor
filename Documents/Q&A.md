 ...
 * 如果皮肤显示为“N/A”，且你的计算机只拥有 AMD 独立显卡，请检查是否安装了皮肤安装包内自带的 `AMDPlugin.dll` 插件；
 * 如果皮肤显示为“N/A”，且你的计算机只拥有 NVIDIA 独立显卡，请检查是否安装了皮肤安装包内自带的 `NvidiaGPU.dll` 插件，并打开“**NVIDIA 控制面板**”，在“**系统信息**”里查看驱动器类型是否为 `DCH` 版本。
