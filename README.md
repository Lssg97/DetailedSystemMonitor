...
本皮肤的官方发行版会使用 Rainmeter 自带皮肤打包器进行打包，安装包扩展名为 `.rmskin`。已经拥有 Rainmeter 软件的用户可在此仓库直接 [**下载**](https://github.com/Lssg97/DetailedSystemMonitor/releases/tag/v3.1) 最新的版本安装包到您的计算机，直接双击文件安装。国内用户在 GitHub 仓库下载速度缓慢，还可前往 [**Cloudreve**](https://file.ykdlb.cn/#/s/9oud?path=%2F) 下载。
...
目前该皮肤及后续更新的官方发布渠道为：[GitHub仓库](https://github.com/Lssg97/DetailedSystemMonitor) 和 [Cloudreve](https://file.ykdlb.cn/#/s/9oud?path=%2F)；相关信息的官方发布渠道有：[中国雨滴论坛](https://bbs.rainmeter.cn/thread-290033-1-1.html) 和 [rainmeter百度贴吧](https://tieba.baidu.com/p/6690463464)。
